...
// /**
//  * PROFESSIONAL TREK ROUTING STRATEGY V3
//  * ✅ Full trek = STITCHED Google Routes (realistic paths)
//  * ✅ Day view = Google Directions (single segment)
//  * ✅ Acclimatization days = Skipped (no duplicate coordinates)
//  * ✅ Route highlighting = FIXED (no disappearing)
//  * ✅ Clean state management with mounted checks
//  */
...
//     // Clear previous route only (keep markers)
...
//      * ============================ */
//     const drawDayRoute = async () => {
//       if (selectedPoints.length < 2) {
//         if (!isMounted) return;
//         console.log(
//           `⏭️ Acclimatization day at ${selectedPoints[0]?.title}`
//         );
//         fitBounds(map, markersToDisplay);
//         setRouteSegmentInfo(
