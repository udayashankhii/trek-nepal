// src/trekkingpage/TrekHighlights.jsx
    ...
    <section className="relative bg-gradient-to-br from-slate-50 to-blue-50 py-16 lg:py-24 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div
          className={
            isMobile
              ? "flex overflow-x-auto pb-8 -mx-4 px-4"
              ...
              <motion.div
                ...
                className={
                  isMobile
                    ? "min-w-[300px] mr-6"
                    : "h-full" +
                      " group relative bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 overflow-hidden"
                }
              >
