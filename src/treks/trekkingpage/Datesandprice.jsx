...
const CostAndDate = forwardRef(({
  ...
  const canGoNextMonth = availableMonths.indexOf(selectedMonth) < availableMonths.length - 1;
  ...
  return (
    <section 
      ...
      {...props}
      aria-label="Trek dates and pricing information"
    >
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-1">
          <header className="mb-6">
            ...
            {/* Trip Type Tabs */}
            <div className="flex gap-2 mb-6" role="tablist" aria-label="Trip type selection">
              <button
                role="tab"
          ...
          <div className="mb-4 text-gray-700">
            <p className="mb-2">
              ...
              <span className="font-semibold">End Dates</span> correspond to your
              return date from Nepal.
            </p>
          </div>
          
          <div className="mb-6 text-gray-700">
            <p>
              The {trekName} set departure dates are tailored for
              the group joining option. If the 14 days {trekName} 
              departure dates don't fit your schedule, we can include alternative
              dates that better suit your needs.
            </p>
          </div>

          {/* Month Navigation */}
          <div className="flex items-center gap-2 mb-6" aria-label="Month selection">
            <button
            ...
            <div className="flex gap-1 flex-wrap" role="group" aria-label="Month selection">
          ...
          {/* Departure Cards */}
          <div className="space-y-4" role="region" aria-label="Available departure dates">
            {filteredDepartures.length === 0 ? (
              <div className="bg-white rounded-lg shadow p-6 text-center text-gray-600">
                <p>No departures available for {MONTHS[selectedMonth]}.</p>
                <p className="text-sm mt-2">Please select a different month or contact us for custom dates.</p>
              </div>
            ) : (
                ...
                >
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center gap-4 flex-1">
                      <div>
                        <div className="text-sm text-gray-500 font-medium">Start Date</div>
                        <div className="font-bold text-lg text-blue-900">
                          {dayjs(departure.start).format("D MMM YYYY")}
                        </div>
                      </div>
                      <div>
                        <div className="text-sm text-gray-500 font-medium">End Date</div>
                        <div className="font-bold text-lg text-blue-900">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center gap-4">
                      <div className="text-right">
                        <div className="text-lg font-bold text-blue-700">
                          Price from{" "}
                          <span className="text-2xl">US${departure.price.toLocaleString()}</span>
                        </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border p-6">
            ...
            <ul className="space-y-2">
              {highlights.map((highlight, index) => (
                ...
                >
                  <span className="text-blue-600 mt-1.5 block w-1.5 h-1.5 rounded-full bg-blue-600 flex-shrink-0" aria-hidden="true"></span>
                  {highlight}
                </li>
              ))}
            </ul>
